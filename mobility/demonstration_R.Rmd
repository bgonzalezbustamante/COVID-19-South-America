...
author: "Bastián González-Bustamante^[DPhil (PhD) Researcher, Department of Politics and International Relations & St Hilda's College, University of Oxford, United Kingdom. Instructor Professor, Management and Public Policies Department, Faculty of Administration and Economics, Universidad de Santiago de Chile (USACH), Chile. Mailing address: St Hilda's College, Cowley Place, Oxford OX4 1DY, United Kingdom. Email: [bastian.gonzalezbustamante@politics.ox.ac.uk](mailto:bastian.gonzalezbustamante@politics.ox.ac.uk). Website: [https://bgonzalezbustamante.com](https://bgonzalezbustamante.com). ORCID iD [http://orcid.org/0000-0003-1510-6820](http://orcid.org/0000-0003-1510-6820)]"
date: "May 28, 2021"
output: 
  pdf_document:
    fig_caption: yes
...
```{r collapse = TRUE, results = "asis", message = FALSE}
## Code based on González-Bustamante (2021) DOI: 10.1016/j.worlddev.2020.105180
